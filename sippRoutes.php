...
Route::group(['middleware' => ['portalAuth']], function() {
	...
	Route::group(['middleware' => ['portalAuth.view']], function() {
		...
		/* === View Gudang === */
		Route::group(['prefix' => 'vchmall/cPengajuanGudang'], function() {
			Route::get('/', 'Gudangmall\cPengajuanGudang@index');		
			Route::post('/search_dt', 'Gudangmall\cPengajuanGudang@search_dt');	
			Route::post('/get_gudang', 'Gudangmall\cPengajuanGudang@get_voucher');	
			Route::post('/show_dtl', 'Gudangmall\cPengajuanGudang@show_dtl');
			Route::post('/search_data_Gudang', 'gudangmall\cPengajuanGudang@search_data_Gudang');		
		});
	...
	Route::group(['middleware' => ['portalAuth.save']], function() {
		...
		/* === Save Master Gudang === */
		Route::group(['prefix' => 'vchmall/cGudangMall'], function() {
			Route::post('/save', 'Gudangmall\cGudangMall@save');
		});

		/* === Save Master Barang === */
		Route::group(['prefix' => 'vchmall/cBarangMall'], function() {
			Route::post('/save', 'Gudangmall\cBarangMall@save');
		});
	...
	Route::group(['middleware' => ['portalAuth.delete']], function() {
		...
		/* === Delete Master Gudang === */
		Route::group(['prefix' => 'vchmall/cGudangMall'], function() {
			Route::post('/delete_dt', 'Gudangmall\cGudangMall@delete_dt');
        });

		/* === Delete Master Barang === */
		Route::group(['prefix' => 'vchmall/cBarangMall'], function() {
			Route::post('/delete_dt', 'Barangmall\cGudangMall@delete_dt');
        });
