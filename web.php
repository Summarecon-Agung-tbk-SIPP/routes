...
Route::group(['middleware' => ['portalAuth']], function() {
	...
	Route::group(['prefix' => 'sipp/barang'], function() {
		Route::get('/', 'Sipp\MasterSipp\BarangController@index');
		});
	Route::group(['prefix' => 'sipp/gudang'], function() {
			Route::get('/', 'Sipp\MasterSipp\GudangController@index');	
		});	
	Route::group(['prefix' => 'sipp/kategoribarang'], function() {
			Route::get('/', 'Sipp\MasterSipp\KategoriBarangController@index');	
	});
	});
});